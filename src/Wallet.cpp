...
{
    return sendTransactionRequest("eth_sendTransaction", TransactionParamsFactory::makeParams(from, to, amount, gas, gasPrice, nonce));
}
...
{
    return sendTransactionRequest("eth_sendTransaction", TransactionParamsFactory::makeParams(from, to, amount, data, gas, gasPrice, nonce));
}
...
{
    return sendTransaction(from.c_str(), to.c_str(), amount, gas, gasPrice, nonce);
}
...
{
    return sendTransaction(from.c_str(), to.c_str(), amount, data.c_str(), gas, gasPrice, nonce);
}
